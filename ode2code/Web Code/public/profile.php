...
$title = "Xiaomi Customers | Store Profile";
...
if(isset($_POST['update_profile']))
{
    ...
    mysqli_query($conn,"UPDATE `customers` SET `name`='$name',`phone`='$phone',`state`='$state',`district`='$district',`city`='$city',`address`='$address' WHERE `id`='$uid'");
}
...
if(isset($_POST['update_password']))
{
    ...
    mysqli_query($conn,"UPDATE `customers` SET `password`='$pass' WHERE `id`='$uid'");
}


$row_cus=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `customers` WHERE `id`=$uid"));
                                            ...
                                            <form method="post" class="theme-form theme-form-2 mega-form">
                                                <div class="row">
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-2 mb-0">Customer Name</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="name" value="<?php echo $row_cus['name'];?>" class="form-control" type="text" placeholder="Enter Your Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="number" name="phone" value="<?php echo $row_cus['phone'];?>" class="form-control" type="text" placeholder="Enter Your  Number">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        <label class="form-label-title col-sm-2 mb-0">Enter Email
                                                            Address</label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control" name="email" type="email" value="<?php echo $row_cus['email'];?>" placeholder="Enter Your Email Address" readonly>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" name="state" id="state" onchange="change_dist()">
                                                                ...
                                                                while($row=mysqli_fetch_assoc($res))
                                                                {
                                                                    $state = $row['name'];
                                                                    ?>
                                                                    <option value="<?php echo $state;?>" <?php if($row_cus['state']==$state) echo 'selected';?> ><?php echo $state;?></option>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" name="district" id="district" onchange="change_city()">
                                                                <option value="<?php echo $row_cus['district'];?>"><?php if($row_cus['district']=='') echo 'Select District'; else echo $row_cus['district'];?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control" name="city" id="city">
                                                                <?php $ccode = $row_cus['city'];
                                                                $cname=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `city` WHERE `id`='$ccode'")); $cname=$cname['name'];?>
                                                                <option value="<?php echo $row_cus['city'];?>"><?php if($row_cus['city']=='') echo 'Select District'; else echo $cname;?></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mb-4 row align-items-center">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <textarea class="form-control" name="address"><?php echo $row_cus['address'];?></textarea>
                                                        </div>
                                                    </div>
