                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <hr>
                            <br>
                            <form class="d-inline-flex" id="sel_store_prod" method="post">
                                <select class="form-control" style="width:300px" name="store_id" id="city" onchange="sel_store_prod()">
                                    <option value="">Filter By Stores</option>
                                    <?php
                                    $res_store=mysqli_query($conn,"SELECT * FROM `stores` ORDER BY id DESC");
                                    while($row=mysqli_fetch_assoc($res_store))
                                    {;?>
                                    <option value="<?php echo $row['id'];?>" <?php if($row['id']==$sid) echo 'selected';?>><?php echo $row['name'].','.$row['district'].','.$row['state'];?></option>
                                    <?php
                                    }?>
                                </select>
                            </form>
                                        ...
                                        <div class="table-responsive table-desi table-product">
                                            <table id="dt1" class="table table-1d all-package">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql="SELECT * FROM `orders` WHERE `sid`='$sid' ORDER BY id DESC";
                                                    else if($sid=='' && $cid!='')
                                                    $sql="SELECT * FROM `orders` WHERE `cid`='$cid' ORDER BY id DESC";
                                                    else if($sid!='' && $cid!='')
                                                    $sql="SELECT * FROM `orders` WHERE `cid`='$cid' AND `sid`='$sid' ORDER BY id DESC";
                                                    ...
                                                    while($row_orders=mysqli_fetch_assoc($res_orders))
                                                    {
                                                            ...
                                                            $sid=$row_orders['sid'];
                                                            $row_store=mysqli_fetch_assoc(mysqli_query($conn,"SELECT * FROM `stores` WHERE `id`=$sid"));
                                                    ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo $row_store['address'];?></td>
                                                                <td>
