                                    ...
                                    <div class="media align-items-center static-top-widget">
                                        <div class="media-body p-0">
                                            ...
                                            <h4 class="mb-0 counter">
                                                <?php
                                                $c=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM `products` WHERE `sid`='$uid'"));
                                                echo $c;
                                                ?>
                                            </h4>
                                        </div>
                                ...
                                <div class=" custome-4-bg b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        <div class="media-body p-0">
                                            ...
                                            <h4 class="mb-0 counter">
                                                <?php
                                                $c=mysqli_num_rows(mysqli_query($conn,"SELECT DISTINCT(`cid`) FROM `orders` WHERE `sid`='$uid'"));
                                                echo $c;
                                                ?>
                                            </h4>
                                        </div>
                                ...
                                <div class=" custome-2-bg  b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        <div class="media-body p-0">
                                            ...
                                            <h4 class="mb-0 counter">
                                                <?php
                                                $c=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM `orders` WHERE `sid`='$uid' AND `del_status`='0'"));
                                                echo $c;
                                                ?>
                                            </h4>
                                        </div>
                                ...
                                <div class=" custome-3-bg b-r-4 card-body">
                                    <div class="media static-top-widget">
                                        <div class="media-body p-0">
                                            ...
                                            <h4 class="mb-0 counter">
                                                <?php
                                                $c=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM `orders` WHERE `sid`='$uid'"));
                                                echo $c;
                                                ?>
                                            </h4>
                                        </div>
